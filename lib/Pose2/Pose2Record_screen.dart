...
class _Pose2RecordState extends State<Pose2Record> {
  ...
  void sendfileA () async{
    ...
    Reference storageReferenceA = storage.ref().child("#${widget.patientNum}_accPose2_${DateTime.now().minute}.cvs");
  ...
  void sendfileG () async{
    ...
    Reference storageReferenceG = storage.ref().child("#${widget.patientNum}_gyroPose2_${DateTime.now().minute}.cvs");
